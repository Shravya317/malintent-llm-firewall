...
print(
    f"[malicious] decision={malicious.decision} risk_score={malicious.risk_score} "
...
print(
    f"[output]    consistent={output_check.consistent} "
...
print(
    f"[stats]     total_requests={stats.total_requests} "
