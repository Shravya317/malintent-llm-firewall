...
Write-Host ""
Write-Host "  https://malintent-backend-638595612528.asia-south1.run.app"
Write-Host ""
Write-Host "Swagger UI"
Write-Host ""
Write-Host "  https://malintent-backend-638595612528.asia-south1.run.app/docs"
Write-Host ""
Write-Host "OpenAPI"
Write-Host ""
Write-Host "  https://malintent-backend-638595612528.asia-south1.run.app/openapi.json"
Write-Host ""
Write-Host "Verify"
Write-Host ""
